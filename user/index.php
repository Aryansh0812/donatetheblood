...
if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {
	...
	<strong>Are you sure to update this record?</strong>
			...
			<div class="col-md-12 col-md-push-1">
				<div class="panel panel-default" style="padding: 20px;">
					<div class="panel-body">
						...
						// echo 'You have saved a life on this date: ';
						// echo $safeDate;
						if ($safeDate == '0') {
							...
							<span> You already saved a life. You wil be able donate after three months.
								We are very thankful to you.</span>
						</div>';
							}
						}
